...
import { ArrowLeft, Mail, Phone, MapPin, User, GraduationCap, CalendarCheck, TrendingUp } from 'lucide-react';
...
const allStudents = [
  ...
  { matricule: 'E20-SEL2-001', name: 'Emma Laurent', email: 'emma.l@example.com', phone: '+243 81 121 2121', address: '11 Q. Salongo, Lemba', level: 'Secondaire', classe: '2ème Électricité', section: 'Humanités', option: 'Électricité', status: 'Inactif', dateJoined: '2020-09-05', dob: '2008-10-10', pob: 'Kinshasa', parentName: 'Valérie Laurent', parentPhone: '+243 99 121 2121', avatar: 'femme congolaise', cover: 'circuit electronique' },
  { matricule: 'E19-SBC3-001', name: 'Arthur Lemoine', email: 'arthur.l@example.com', phone: '+243 81 131 3131', address: '12 Av. de la Démocratie, Kasa-Vubu', level: 'Secondaire', classe: '3ème Biochimie', section: 'Humanités', option: 'Biochimie', status: 'Actif', dateJoined: '2019-09-05', dob: '2007-12-05', pob: 'Kananga', parentName: 'Benoît Lemoine', parentPhone: '+243 99 131 3131', avatar: 'homme congolais', cover: 'laboratoire chimie' },
